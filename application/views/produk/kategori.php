<section class="container mt-n5">
  ...
  <div class="d-flex justify-content-between">
    ...
    <button type="button" class="btn btn-sm btn-outline-light mb-2 btn-tambah" data-toggle="modal"
      data-target="#tb-kategori">
    ...
    <table class="table table-borderless text-white">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-sm btn-outline-warning mb-2 edit-kategori" data-toggle="modal"
              data-target="#tb-kategori" data-id="<?= $k['id_kategori']; ?>">
              <a href="#" class="text-warning" data-toggle="tooltip" data-placement="top" title="Edit Kategori"
                id="hapus">
                <i data-feather="edit"></i>
              </a>
            </button>

            <button type="button" class="btn btn-sm btn-outline-danger mb-2 hapus-kategori" data-toggle="modal"
              data-target="#dl-kategori" data-id="<?= $k['id_kategori']; ?>">
              <a href="#" class="text-danger" data-toggle="tooltip" data-placement="top" title="Hapus Produk"
                id="hapus">
