    ...
    <div class="row">
      <div class="col-md-6 text-white">
        <div class="d-flex flex-column justify-content-center h-100">
          ...
          <p>Cocok buat kamu yang suka produk <?= $hero[0]['label_produk']; ?></p>
          <p>Rp. <?= rupiah($hero[0]['harga']); ?> ,-</p>

          <?php if ($this->session->userdata('role_id') == 2) : ?>
          <div class="row">
            <div class="container">
              <a href="<?= base_url('produk/dProduk/') . $hero[0]['id_produk']; ?>" class="btn btn-outline-light mr-1"
                title="Info Produk">
      ...
      <div class="col-md-6">
        <a href="<?= base_url('produk/dProduk/') . $hero[0]['id_produk']; ?>" class="d-flex justify-content-center m-4">
          <img src="<?= base_url('assets/img/produk/') . $hero[0]['foto_produk']; ?>"
            alt="<?= $hero[0]['foto_produk'] ?>" class="img-fluid shadow hero-img">
        </a>
      </div>
    </div>
  </div>
          ...
          <div class="card-body">
            <div class="d-flex">
              <a href="<?= base_url('produk/dProduk/') . $u['id_produk']; ?>" class="text-center">
                <img src="<?= base_url('assets/img/produk/') . $u['foto_produk']; ?>" alt=""
    ...
    <div class="row">
      <div class="col-md-6 text-white">
        <div class="d-flex flex-column justify-content-center h-100">
          ...
          <p>Cocok buat yang suka produk <?= $hero[1]['label_produk']; ?></p>
          <p>Rp. <?= rupiah($hero[1]['harga']); ?> ,-</p>

          <?php if ($this->session->userdata('role_id') == 2) : ?>
          <div class="row">
            <div class="container">
              <a href="<?= base_url('produk/dProduk/') . $hero[1]['id_produk']; ?>" class="btn btn-outline-light mr-1"
                title="Info Produk">
                <i data-feather="info" stroke-width="1"></i>
              </a>
      ...
      <div class="col-md-6">
        <a href="" class="d-flex justify-content-center m-4">
          <img src="<?= base_url('assets/img/produk/') . $hero[1]['foto_produk']; ?>"
            alt="<?= $hero[1]['foto_produk'] ?>" class="img-fluid shadow hero-img">
        </a>
      </div>
    </div>
  </div>
          ...
          <div class="card-body">
            ...
            <div class="d-flex">
              <a href="" class=" text-center">
                <img src="<?= base_url('assets/img/produk/') . $d['foto_produk']; ?>" alt="<?= $d['foto_produk']; ?>"
                  class="img-fluid mb-4 shadow">
              </a>
            </div>
            <div class="text-center">
