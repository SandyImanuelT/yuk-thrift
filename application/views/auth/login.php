  ...
  <div class="row">
    <div class="col-md-6 col-12 bg-white">
      <div class="d-flex justify-content-center align-items-center hv-100">
        <div class="login-box">
          <!-- <div class="logo">
            <img src="<?= base_url(); ?>assets/img/main-logo.png" alt="logo" style="width: 80px;">
          </div> -->

          <div class="main">
            <?= $this->session->flashdata('pesan'); ?>
            <h3>Log in.</h3>
            <p>Halo Selamat Datang Kembali di <span style="color: #0a4a4a; font-weight:400;">Yuk Thrift.</span></p>
