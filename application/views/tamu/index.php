...
<body>
  ...
  <section class="bg-white">
    <div class="container">
      <h1>Produk Unggulan | Repost by <a href='https://valcoding.com/' title='valcoding.com' target='_blank'>valcoding.com</a>
			</h1>
  ...
  <footer>
    <div class="container">
      ...
      <span class="mt-5 mb-5 float-right">
        Crafted with <span class="text-danger">♥</span> by dIkaps | Repost by <a href='https://valcoding.com/' title='valcoding.com' target='_blank'>valcoding.com</a>
